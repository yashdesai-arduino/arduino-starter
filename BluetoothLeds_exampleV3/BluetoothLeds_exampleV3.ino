...
void loop()
{
  if (Serial.available() > 0)
  {
    ...
    switch(data){
      ...
      case 49:  if(on2==0) {digitalWrite(led2, HIGH); on2 = 1;Serial.print("LED 2 is ON\n");} else {digitalWrite(led2, LOW); on2=0;Serial.print("LED 2 is OFF\n");} break;
   
      case 50:  if(on3==0) {digitalWrite(led3, HIGH); on3 = 1;Serial.print(" CFL is ON\n");} else {digitalWrite(led3, LOW); on3=0;Serial.print("CFL is OFF\n");} break;
     
      case 51:  if(on4==0) {digitalWrite(led4, HIGH); on4 = 1;Serial.print("FAN is ON\n");} else {digitalWrite(led4, LOW); on4=0;Serial.print("FAN is OFF\n");} break;
